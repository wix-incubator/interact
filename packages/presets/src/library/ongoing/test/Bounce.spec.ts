...
describe('Bounce', () => {
  describe('style function', () => {
    ...
    test('custom power - medium', () => {
      const mockOptions: TimeAnimationOptions = {
        ...baseMockOptions,
        namedEffect: { type: 'Bounce', power: 'medium' },
      };
    ...
    test('custom power - hard', () => {
      const mockOptions: TimeAnimationOptions = {
        ...baseMockOptions,
        namedEffect: { type: 'Bounce', power: 'hard' },
      };
      ...
      const expectedResult = [
        {
          ...
          keyframes: [
            {
              offset: 0,
              translate: '0px calc(0px * 2)',
              easing: 'cubic-bezier(0.39, 0.575, 0.565, 1)',
            },
            {
              offset: 0.08800000000000001,
              translate: '0px calc(-27.5px * 2)',
              easing: 'cubic-bezier(0.39, 0.575, 0.565, 1)',
            },
            {
              offset: 0.17600000000000002,
              translate: '0px calc(-43.5px * 2)',
              easing: 'cubic-bezier(0.39, 0.575, 0.565, 1)',
            },
            {
              offset: 0.265,
              translate: '0px calc(-49px * 2)',
              easing: 'cubic-bezier(0.39, 0.575, 0.565, 1)',
            },
            {
              offset: 0.353,
      ...
      const expectedResult = [
        {
          ...
          keyframes: [
            {
              offset: 0,
              translate: '0px calc(0px * 3)',
              easing: 'cubic-bezier(0.39, 0.575, 0.565, 1)',
            },
            {
              offset: 0.08800000000000001,
              translate: '0px calc(-27.5px * 3)',
              easing: 'cubic-bezier(0.39, 0.575, 0.565, 1)',
            },
            {
              offset: 0.17600000000000002,
              translate: '0px calc(-43.5px * 3)',
              easing: 'cubic-bezier(0.39, 0.575, 0.565, 1)',
            },
            {
              offset: 0.265,
              translate: '0px calc(-49px * 3)',
              easing: 'cubic-bezier(0.39, 0.575, 0.565, 1)',
            },
            {
              offset: 0.353,
