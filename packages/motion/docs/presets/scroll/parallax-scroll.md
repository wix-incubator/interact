...
const scene = getWebAnimation(element, {
...
const subtleParallax = getWebAnimation(element, {
  type: 'ScrubAnimationOptions',
  namedEffect: { 
    type: 'ParallaxScroll',
    speed: 0.2,
...
const dramaticParallax = getWebAnimation(element, {
  type: 'ScrubAnimationOptions',
  namedEffect: { 
    type: 'ParallaxScroll',
    speed: 0.8,
...
const reverseParallax = getWebAnimation(element, {
  type: 'ScrubAnimationOptions',
  namedEffect: { 
    type: 'ParallaxScroll',
...
const entranceParallax = getWebAnimation(element, {
  type: 'ScrubAnimationOptions',
  namedEffect: { 
    type: 'ParallaxScroll',
    speed: 0.6,
...
const exitParallax = getScrgetWebAnimationubScene(element, {
  type: 'ScrubAnimationOptions',
  namedEffect: { 
    type: 'ParallaxScroll',
    speed: 0.4,
...
const customRangeParallax = getWebAnimation(element, {
  type: 'ScrubAnimationOptions',
  namedEffect: { 
    type: 'ParallaxScroll',
    speed: 0.5
...
function setupVideoParallax() {
  ...
  getWebAnimation(videoContainer, {
    type: 'ScrubAnimationOptions',
    namedEffect: { 
      type: 'ParallaxScroll',
