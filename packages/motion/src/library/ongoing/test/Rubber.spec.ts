...
describe('Rubber', () => {
  ...
  test('custom power - soft - style method', () => {
    const mockOptions: TimeAnimationOptions = {
      ...baseMockOptions,
      duration: 1000,
      namedEffect: { power: 'soft' } as RubberType,
    };
    ...
    const expectedResult = [
      {
        ...
        delay: 0,
        custom: {
          '--motion-scale-x-45': 1.03,
          '--motion-scale-y-45': 0.93,
          '--motion-scale-x-56': 0.9,
          '--motion-scale-y-56': 1.03,
          '--motion-scale-x-66': 1.02,
          '--motion-scale-y-66': 0.96,
          '--motion-scale-x-78': 0.98,
          '--motion-scale-y-78': 1.02,
          '--motion-scale-x-89': 1.005,
          '--motion-scale-y-89': 0.9995,
          '--motion-scale-x-100': 1,
          '--motion-scale-y-100': 1,
        },
        keyframes: [
  ...
  test('custom power - soft - web method', () => {
    const mockOptions: TimeAnimationOptions = {
      ...baseMockOptions,
      duration: 1000,
      namedEffect: { power: 'soft' } as RubberType,
    ...
    const expectedResult = [
      {
        ...
        keyframes: [
          {
            offset: 0.45,
            transform: 'rotateZ(var(--comp-rotate-z, 0deg)) scale(1.03, 0.93)',
          },
          {
            offset: 0.56,
            transform: 'rotateZ(var(--comp-rotate-z, 0deg)) scale(0.9, 1.03)',
          },
          {
            offset: 0.66,
            transform: 'rotateZ(var(--comp-rotate-z, 0deg)) scale(1.02, 0.96)',
          },
          {
            offset: 0.78,
            transform: 'rotateZ(var(--comp-rotate-z, 0deg)) scale(0.98, 1.02)',
          },
          {
            offset: 0.89,
  ...
  test('custom power - medium - style method', () => {
    const mockOptions: TimeAnimationOptions = {
      ...baseMockOptions,
      duration: 1000,
      namedEffect: { power: 'medium' } as RubberType,
    };
  ...
  test('custom power - medium - web method', () => {
    const mockOptions: TimeAnimationOptions = {
      ...baseMockOptions,
      duration: 1000,
      namedEffect: { power: 'medium' } as RubberType,
  ...
  test('custom power - hard - style method', () => {
    const mockOptions: TimeAnimationOptions = {
      ...baseMockOptions,
      duration: 1000,
      namedEffect: { power: 'hard' } as RubberType,
    };
    ...
    const expectedResult = [
      {
        ...
        delay: 0,
        custom: {
          '--motion-scale-x-45': 1.13,
          '--motion-scale-y-45': 0.83,
          '--motion-scale-x-56': 0.85,
          '--motion-scale-y-56': 1.08,
          '--motion-scale-x-66': 1.12,
          '--motion-scale-y-66': 0.86,
          '--motion-scale-x-78': 0.93,
          '--motion-scale-y-78': 1.07,
          '--motion-scale-x-89': 1.105,
          '--motion-scale-y-89': 0.8995,
          '--motion-scale-x-100': 1,
          '--motion-scale-y-100': 1,
        },
        keyframes: [
  ...
  test('custom power - hard - web method', () => {
    const mockOptions: TimeAnimationOptions = {
      ...baseMockOptions,
      duration: 1000,
      namedEffect: { power: 'hard' } as RubberType,
    ...
    const expectedResult = [
      {
        ...
        keyframes: [
          {
            offset: 0.45,
            transform: 'rotateZ(var(--comp-rotate-z, 0deg)) scale(1.13, 0.83)',
          },
          {
            offset: 0.56,
            transform: 'rotateZ(var(--comp-rotate-z, 0deg)) scale(0.85, 1.08)',
          },
          {
            offset: 0.66,
            transform: 'rotateZ(var(--comp-rotate-z, 0deg)) scale(1.12, 0.86)',
          },
          {
            offset: 0.78,
            transform: 'rotateZ(var(--comp-rotate-z, 0deg)) scale(0.93, 1.07)',
          },
          {
            offset: 0.89,
