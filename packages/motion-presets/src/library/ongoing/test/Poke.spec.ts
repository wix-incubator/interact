...
describe('Poke', () => {
  describe('web() method', () => {
    ...
    test('Poke animation with custom power - soft', () => {
      const mockOptions: TimeAnimationOptions = {
        ...baseMockOptions,
        duration: 1000,
        namedEffect: { power: 'soft' } as Poke,
      };
      ...
      const expectedResult: Partial<AnimationData>[] = [
        {
          name: 'motion-poke-1',
          custom: {
            '--motion-translate-x': 1,
            '--motion-translate-y': 0,
          },
          keyframes: [
            {
              offset: 0.17,
              translate: 'calc(1 * 7px) calc(0 * 7px)',
            },
            {
              offset: 0.32,
              translate: 'calc(1 * 25px) calc(0 * 25px)',
            },
            {
              offset: 0.48,
              translate: 'calc(1 * 8px) calc(0 * 8px)',
            },
            {
              offset: 0.56,
              translate: 'calc(1 * 11px) calc(0 * 11px)',
            },
            {
              offset: 0.66,
              translate: 'calc(1 * 25px) calc(0 * 25px)',
            ...
            {
              offset: 0.83,
              translate: 'calc(1 * 4px) calc(0 * 4px)',
            },
            {
              offset: 1,
              translate: 'calc(1 * 0px) calc(0 * 0px)',
            },
          ],
        },
      ];
    ...
    test('Poke animation with custom power - medium', () => {
      const mockOptions: TimeAnimationOptions = {
        ...baseMockOptions,
        duration: 1000,
        namedEffect: { power: 'medium' } as Poke,
      };
      ...
      const expectedResult: Partial<AnimationData>[] = [
        {
          name: 'motion-poke-1',
          custom: {
            '--motion-translate-x': 2,
            '--motion-translate-y': 0,
          },
          keyframes: [
            {
              offset: 0.17,
              translate: 'calc(2 * 7px) calc(0 * 7px)',
            },
            {
              offset: 0.32,
              translate: 'calc(2 * 25px) calc(0 * 25px)',
            },
            {
              offset: 0.48,
              translate: 'calc(2 * 8px) calc(0 * 8px)',
            },
            {
              offset: 0.56,
              translate: 'calc(2 * 11px) calc(0 * 11px)',
            },
            {
              offset: 0.66,
              translate: 'calc(2 * 25px) calc(0 * 25px)',
            ...
            {
              offset: 0.83,
              translate: 'calc(2 * 4px) calc(0 * 4px)',
            },
            {
              offset: 1,
              translate: 'calc(2 * 0px) calc(0 * 0px)',
            },
          ],
        },
      ];
    ...
    test('Poke animation with custom power - hard', () => {
      const mockOptions: TimeAnimationOptions = {
        ...baseMockOptions,
        duration: 1000,
        namedEffect: { power: 'hard' } as Poke,
      };
      ...
      const expectedResult: Partial<AnimationData>[] = [
        {
          name: 'motion-poke-1',
          custom: {
            '--motion-translate-x': 4,
            '--motion-translate-y': 0,
          },
          keyframes: [
            {
              offset: 0.17,
              translate: 'calc(4 * 7px) calc(0 * 7px)',
            },
            {
              offset: 0.32,
              translate: 'calc(4 * 25px) calc(0 * 25px)',
            },
            {
              offset: 0.48,
              translate: 'calc(4 * 8px) calc(0 * 8px)',
            },
            {
              offset: 0.56,
              translate: 'calc(4 * 11px) calc(0 * 11px)',
            },
            {
              offset: 0.66,
              translate: 'calc(4 * 25px) calc(0 * 25px)',
            ...
            {
              offset: 0.83,
              translate: 'calc(4 * 4px) calc(0 * 4px)',
            },
            {
              offset: 1,
              translate: 'calc(4 * 0px) calc(0 * 0px)',
            },
          ],
        },
      ];
  ...
  describe('style() method', () => {
    ...
    test('Poke.style animation with custom power - soft', () => {
      const mockOptions: TimeAnimationOptions = {
        ...baseMockOptions,
        duration: 1000,
        namedEffect: { power: 'soft' } as Poke,
    ...
    test('Poke.style animation should use CSS custom properties', () => {
      const mockOptions: TimeAnimationOptions = {
        ...baseMockOptions,
        duration: 1000,
        namedEffect: { direction: 'left', power: 'medium' } as Poke,
      };
      ...
      expect(result[0].keyframes[0].translate).toBe(
        'calc(var(--motion-translate-x) * 7px) calc(var(--motion-translate-y) * 7px)',
      );
      expect(result[0].keyframes[1].translate).toBe(
        'calc(var(--motion-translate-x) * 25px) calc(var(--motion-translate-y) * 25px)',
      );
    });
  });
