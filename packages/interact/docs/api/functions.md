...
3. **Excludes completed animations**: Uses `:not([data-interact-enter="start"])` to show elements after their animation completes

**For the `web` integration (with custom elements)**:

```css
@media (prefers-reduced-motion: no-preference) {
  [data-interact-initial='true'] > :first-child:not([data-interact-enter='start']) {
    visibility: hidden;
    transform: none;
    translate: none;
    scale: none;
...
```css
@media (prefers-reduced-motion: no-preference) {
  [data-interact-initial='true']:not([data-interact-enter='start']) {
    visibility: hidden;
    transform: none;
    translate: none;
    scale: none;
